...
$row = $result->fetch_assoc();
   if($row[Type] == 'Smartphone')
        ...
        echo "
        		<a href=\"http://giolmolinellioppedisano.altervista.org/mashup/dispositivi.html\">Dispositivi</a> >
                	<a href=\"http://giolmolinellioppedisano.altervista.org/mashup/".$path."\">".$row[Type]."</a> >
                    	<a href=\"#\">".$model."</a>
        ";
} else {
    echo "0 results.";
