              ...
              <div class=\"col-sm-12\">
               	<div class=\"col-sm-4\">
               		<div class=\"categorybox\">
                         ...
                         echo "<p><a href=\"http://giolmolinellioppedisano.altervista.org/mashup/configposta.html\">Configurazione Posta</a></p>";
                         echo "<p><a href=\"http://giolmolinellioppedisano.altervista.org/mashup/supportotecnico.html\">Riparazione</a></p>
                	</div>
                </div>
                <div class=\"col-sm-4\">
                	<div class=\"categorybox\">Servizi Smart Life disponibili";
                          ...
                          while($row2 = $result2->fetch_assoc())
                              echo "<p><a href=\"".$row2[pagelink]."\">".$row2[Name]."</a></p>";
                              }
                          echo"
                    </div>
                </div>";
                if($row[Type]=="Smartphone")
                         echo "<div class=\"col-sm-4\">
                	<div class=\"categorybox\"><a href=\"http://giolmolinellioppedisano.altervista.org/mashup/retemobile.html\">Piani Telefonici</a></div>
                </div>";
                echo "</div>";
} else {
